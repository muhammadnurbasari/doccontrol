...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Master</span> <span class="label label-important master"></span></a>
      <ul>
        <li class="users" style="display : none;"><a href="<?php echo base_url('result/user'); ?>">Users</a></li>
        <li class="department" style="display : none;"><a href="<?php echo base_url('result/department'); ?>">Departments</a></li>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-file"></i> <span>Transaksi</span> <span class="label label-important transaksi"></span></a>
      <ul>
        ...
        <li class="distribution" style="display : none;"><a href="<?php echo base_url('result/notfound'); ?>">Distributions</a></li>
