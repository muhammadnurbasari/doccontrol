                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <span class="badge tombol badge-important hapus" data-toggle="modal" data-target="#deletemodal" data-id="<?php echo $value[$table.'_id']; ?>" data-name="<?php echo $value['department_code']; ?>"><i class="icon-trash"></i></span>
                      </td>  
                    </tr>
                  <?php endforeach ?>
                </tbody>
